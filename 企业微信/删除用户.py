...
def deluser(code):
    ...
    api_url='https://qyapi.weixin.qq.com/cgi-bin/user/delete?access_token={}&userid={}'.format(ACCESS_TOKEN,code)

    response=requests.get(api_url)
    #说明这个data参数是用str,重温下,dump将dict转为string,loads将str转为dict(json)
...
if __name__ == '__main__':
    ...
    list=['11852','63308','11859','11842','60922','23723','62723','61234','46599','11824','62704','11811','11729','58417']
    for i in list:
        deluser('%s'%i)
